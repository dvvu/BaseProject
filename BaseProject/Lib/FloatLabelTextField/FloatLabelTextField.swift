...
@IBDesignable class FloatLabelTextField: UITextField {
    ...
    @IBInspectable var placeHolderColor:UIColor = UIColor.lightGray {
        didSet {
            let att = NSAttributedString(string: self.placeholder!, attributes: [NSAttributedString.Key.foregroundColor: self.placeHolderColor])
	...
	override func textRect(forBounds bounds:CGRect) -> CGRect {
		...
		if let txt = text , !txt.isEmpty {
            ...
            r = r.insetBy(dx: 0, dy: 0) //UIEdgeInsetsInsetRect(r, UIEdgeInsets(top: top, left: 0.0, bottom: 0.0, right: 0.0))
		}
		return r.integral
	}
